...
public class ConfigTemplateDialog extends javax.swing.JDialog {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        else
        {
            try 
            {
                ...
                model.removeRow(tblTemplates.getSelectedRow());    
            } 
            catch (Exception e)
            {
    ...
    private void tblTemplatesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTemplatesMouseClicked
        ...
        tplName = tblTemplates.getValueAt(tblTemplates.getSelectedRow(), 0).toString();
        tplPath = tblTemplates.getValueAt(tblTemplates.getSelectedRow(), 1).toString();
    }//GEN-LAST:event_tblTemplatesMouseClicked

    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try {
            System.out.println(tplName.trim() + "\t" + tplPath.trim());
            MainForm mainForm = new MainForm();
            EditTemplateDialog editTemplateDialog = new EditTemplateDialog(mainForm, true, tplName);
            editTemplateDialog.setVisible(rootPaneCheckingEnabled);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Please select a template to edit!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_btnEditActionPerformed

    private void loadTemplates() throws InvalidFileFormatException, IOException
    {
